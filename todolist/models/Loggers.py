...
critical_file_handler = logging.FileHandler('critical_errors.log', encoding='utf-8')
critical_formatter = logging.Formatter('%(asctime)s - %(name)s - %(levelname)s - %(message)s')
